...
function resetPassword() {
    ...
    .then(data => {
        let msgHtml = `<div class="alert alert-success mt-3 w-100 px-2" >${data.message}!</div>`;
    ...
    .catch(err => {
        ...
        document.getElementById("resetMessage").innerHTML = '<div class="alert alert-danger">Something went wrong.</div>';
    });
}
